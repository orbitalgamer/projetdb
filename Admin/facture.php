...
$pdf->MultiCell(0, 10, utf8_decode('Le client se voit donc réclamer la somme de '.$resultat['Prix']).' euro '.utf8_decode('pour au plus tard le '.date("d-m-y",strtotime('+1 Months', strtotime($resultat['DateDebut']))))) ;
