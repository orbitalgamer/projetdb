...
$pdf->MultiCell(0, 10, utf8_decode('Pour réaliser ce trajet, le chauffeur à parcourue '.$resultat['DistanceParcourue']. ' pour un tarif lors du dit service de '.$resultat['Tarif']).' euro/km.' );
