...
<div class="container">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6 text-center">
            <button type="button" class="btn btn-outline-secondary" onclick="window.location.href='voircourse.php?Id=<?php echo $avis["IdCourse"]; ?>'">voir la course au complet</button>
        </div>
    </div>
